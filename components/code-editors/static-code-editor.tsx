...
const usePersistentSandpack = (customFiles: CustomFiles | null = null, storageKey: string = 'static-sandpack-files') => {
...
const StaticCodeEditor = ({ customFiles = null, storageKey = 'static-sandpack-files' }: StaticCodeEditorProps) => {
  const { 
    files, 
    setFiles,
    isLoaded 
