...
const usePersistentSandpack = (customFiles: CustomFiles | null = null, storageKey: string = 'vue-sandpack-files') => {
...
const VueCodeEditor = ({ customFiles = null, storageKey = 'vue-sandpack-files' }: VueCodeEditorProps) => {
  const { 
    files, 
    setFiles,
    isLoaded 
