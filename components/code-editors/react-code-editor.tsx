...
const usePersistentSandpack = (customFiles: CustomFiles | null = null, storageKey: string = 'react-sandpack-files') => {
...
const ReactCodeEditor = ({ customFiles = null, storageKey = 'react-sandpack-files' }: ReactCodeEditorProps) => {
  const { 
    files, 
    setFiles,
    isLoaded 
