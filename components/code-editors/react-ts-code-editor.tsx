...
interface ReactTsCodeEditorProps {
  customFiles?: CustomFiles | null;
  storageKey?: string;
}

// Add this hook to handle auto-saving and loading from localStorage
const usePersistentSandpack = (customFiles: CustomFiles | null = null, storageKey: string = 'react-ts-sandpack-files') => {
...
const ReactTsCodeEditor = ({ customFiles = null, storageKey = 'react-ts-sandpack-files' }: ReactTsCodeEditorProps) => {
  const { 
    files, 
    setFiles,
    isLoaded 
...
export default ReactTsCodeEditor; 