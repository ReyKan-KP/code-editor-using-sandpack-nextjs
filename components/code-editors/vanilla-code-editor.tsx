...
interface VanillaCodeEditorProps {
  customFiles?: CustomFiles | null;
  storageKey?: string;
}

// Add this hook to handle auto-saving and loading from localStorage
const usePersistentSandpack = (customFiles: CustomFiles | null = null, storageKey: string = 'vanilla-sandpack-files') => {
...
const VanillaCodeEditor = ({ customFiles = null, storageKey = 'vanilla-sandpack-files' }: VanillaCodeEditorProps) => {
  const { 
    files, 
    setFiles,
    isLoaded 
...
export default VanillaCodeEditor; 