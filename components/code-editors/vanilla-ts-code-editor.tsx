...
interface VanillaTsCodeEditorProps {
  customFiles?: CustomFiles | null;
  storageKey?: string;
}

// Add this hook to handle auto-saving and loading from localStorage
const usePersistentSandpack = (customFiles: CustomFiles | null = null, storageKey: string = 'vanilla-ts-sandpack-files') => {
...
const VanillaTsCodeEditor = ({ customFiles = null, storageKey = 'vanilla-ts-sandpack-files' }: VanillaTsCodeEditorProps) => {
  const { 
    files, 
    setFiles,
    isLoaded 
...
export default VanillaTsCodeEditor; 