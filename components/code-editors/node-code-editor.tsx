...
const usePersistentSandpack = (customFiles: CustomFiles | null = null, storageKey: string = 'node-sandpack-files') => {
...
const NodeCodeEditor = ({ customFiles = null, storageKey = 'node-sandpack-files' }: NodeCodeEditorProps) => {
  const { 
    files, 
    setFiles,
    isLoaded 
