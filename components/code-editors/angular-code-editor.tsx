...
const usePersistentSandpack = (customFiles: CustomFiles | null = null, storageKey: string = 'angular-sandpack-files') => {
...
const AngularCodeEditor = ({ customFiles = null, storageKey = 'angular-sandpack-files' }: AngularCodeEditorProps) => {
  const { 
    files, 
    setFiles,
    isLoaded 
