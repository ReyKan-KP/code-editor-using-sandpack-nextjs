...
interface VueTsCodeEditorProps {
  customFiles?: CustomFiles | null;
  storageKey?: string;
}

// Add this hook to handle auto-saving and loading from localStorage
const usePersistentSandpack = (customFiles: CustomFiles | null = null, storageKey: string = 'vue-ts-sandpack-files') => {
...
const VueTsCodeEditor = ({ customFiles = null, storageKey = 'vue-ts-sandpack-files' }: VueTsCodeEditorProps) => {
  const { 
    files, 
    setFiles,
    isLoaded 
...
export default VueTsCodeEditor; 